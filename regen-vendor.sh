...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/device.google.atv.audio_proxy@7.1-service"
    ...
    "etc/aoc/HEADSET.dat"
    "etc/aoc/downlink_dock_config.pb"
    "etc/aoc/downlink_headset_config.pb"
    "etc/aoc/downlink_tablet_stereo_config.pb"
    "etc/aoc/mcps.dat"
    "etc/aoc/recording.gatf"
    "etc/aoc/smartfeature.gstf"
    "etc/aoc/uplink_dock_aec_off_config.pb"
    "etc/aoc/uplink_dock_config.pb"
    "etc/aoc/uplink_headset_aec_off_config.pb"
    "etc/aoc/uplink_headset_config.pb"
    "etc/aoc/uplink_tablet_stereo_aec_off_config.pb"
    "etc/aoc/uplink_tablet_stereo_config.pb"
    ...
    "etc/audio_proxy_policy_configuration.xml"
    "etc/bluetooth_audio_policy_configuration_7_0.xml"
    "etc/bluetooth_power_limits.csv"
    "etc/bluetooth_power_limits_GTU8P_CA.csv"
    "etc/bluetooth_power_limits_GTU8P_EU.csv"
    "etc/bluetooth_power_limits_GTU8P_JP.csv"
    "etc/bluetooth_power_limits_GTU8P_US.csv"
    ...
    "etc/display_golden_boe-ts110f5mlg0-rt4_cal0.pb"
    "etc/display_golden_csot-ppa957db2d-rt4_cal0.pb"
    "etc/fs_config_dirs"
    "etc/fs_config_files"
    "etc/fstab.gs201"
    ...
    "etc/init/device.google.atv.audio_proxy@7.1-service.rc"
    ...
    "etc/modem/camera_rear_main_mipi_coex_table.csv"
    ...
    "etc/permissions/android.software.telecom.xml"
    ...
    "etc/uwb/UWB-calibration-au.conf"
    ...
    "etc/uwb/UWB-calibration-uk.conf"
    ...
    "etc/vintf/manifest/android.hardware.lights-service.tangorpro.xml"
    ...
    "etc/vintf/manifest/manifest_audio_proxy_7_1.xml"
    ...
    "firmware/L2-cs35l41-dsp1-spk-cali.bin"
    "firmware/L2-cs35l41-dsp1-spk-diag.bin"
    "firmware/L2-cs35l41-dsp1-spk-prot.bin"
    "firmware/R-cs35l41-dsp1-spk-cali.bin"
    "firmware/R-cs35l41-dsp1-spk-diag.bin"
    "firmware/R-cs35l41-dsp1-spk-prot.bin"
    "firmware/R2-cs35l41-dsp1-spk-cali.bin"
    "firmware/R2-cs35l41-dsp1-spk-diag.bin"
    "firmware/R2-cs35l41-dsp1-spk-prot.bin"
    ...
    "lib64/device.google.atv.audio_proxy-aidl-V3-ndk.so"
